...
const AboutMe = () => {
  return (
    <div className="flex items-center justify-center min-h-screen bg-navy-900 text-white p-8 font-sans">
      <div className="max-w-7xl">
        <div className="bg-black space-x-2 rounded-3xl p-8">
          <h1 className="text-4xl font-bold mb-4 font-roboto-mono">ABOUT ME</h1>
          <div>
            <p className="mt-6 font-roboto text-md max-w-4xl">
            ...
            <div className="flex items-start mt-8">
              <div className="hidden md:block flex-1 ml-28">
                <div className="bg-transparent p-1 w-60 h-auto flex items-center justify-center">
                  <img
              ...
              <div className="flex-0">
                ...
                <div className="mt-2">
                  ...
                  <p className="text-lg font-roboto mt-2">2021 - Current</p>
                  <p className="text-lg font-roboto mt-2">
                  ...
                  <p className="text-lg font-roboto mt-2">GPA : 2.64</p>
                </div>
              </div>
            </div>
          </div>
