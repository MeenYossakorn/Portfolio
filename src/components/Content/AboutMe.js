    ...
    <div>
      <div className="flex items-center justify-center min-h-screen  text-white p-12 font-roboto scrollbar-hide mt-40">
        <div className="max-w-[1300px] bg-black bg-opacity-30 space-x-2 rounded-3xl p-8">
          <h1 className="text-3xl font-bold mb-4 font-roboto-mono">ABOUT ME</h1>
          <div className=" mt-4 px-10">
            <div>
              <p className=" font-roboto text-sm max-w-[1300px]   ">
                ...
                Design, React, HTML, and CSS, gained through various university
                projects. I am committed to continuous learning and
                ...
                <div className="mr-16">
                  <div className="flex-0">
                    ...
                    <div className="mt-2 ">
                      ...
                      <p className="text-sm font-roboto mt-2">2021 - Current</p>
                      <p className="text-sm font-roboto mt-2">
